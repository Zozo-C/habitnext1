...
export const explorePlanSections = [
  {
    ...
    templates: [
      { id: 'sunflower', name: '向日葵型小課程', tag: '花朵型', color: '#F5F0E8', accent: '#C9A961', emoji: '🌻', imageUrl: '/flowers/sunflower.svg', by: 'HabitNext 系統', description: '你像向日葵一樣會隨著能量消長與代謝節律而轉動，血糖波動大、容易餓、飯後想睡是常見困擾。', count: 3 },
      { id: 'orchid',    name: '蘭花型小課程',   tag: '花朵型', color: '#F3F0ED', accent: '#9B7C66', emoji: '🌸', imageUrl: '/flowers/orchid.svg', by: 'HabitNext 系統', description: '你像蘭花一樣對環境變化比較敏感，需要穩定以及規律來支撐，當作息混亂壓力來襲時容易失衡。', count: 2 },
      { id: 'rose',      name: '玫瑰型小課程',   tag: '花朵型', color: '#F3F0ED', accent: '#A67452', emoji: '🌹', imageUrl: '/flowers/rose.svg', by: 'HabitNext 系統', description: '你像玫瑰一樣有盛開與含苞的節奏，身體對週期變化比較敏銳，尤其是情緒與體力的起伏。', count: 5 },
      { id: 'daisy',     name: '雛菊型小課程',   tag: '花朵型', color: '#EEF2EA', accent: '#8B9B6F', emoji: '🌼', imageUrl: '/flowers/daisy.svg', by: 'HabitNext 系統', description: '你像雛菊一樣穩定、日常、自然且平衡。大多數時候沒有特別明顯的不適，但這不代表不需要照顧自己。', count: 7 },
    ],
  },
  {
    id: 'sleep',
    ...
    templates: [
      { id: 'stress-sleep',    name: '壓力型睡眠處方',     tag: '睡眠', color: '#F0EDF5', accent: '#8B7B8B', emoji: '😵‍💫', by: 'HabitNext 系統', description: '大腦過度活躍、交感神經亢奮，明明很累卻睡不著，睡前思緒停不下來。', count: 4 },
      { id: 'rhythm-sleep',    name: '節律型睡眠處方',     tag: '睡眠', color: '#EDF2F6', accent: '#7A8B96', emoji: '🌙', by: 'HabitNext 系統', description: '生理時鐘延遲或混亂，不是睡不著，而是睡錯時間；晚睡晚起、週末補眠惡化節律。', count: 6 },
      { id: 'metabolic-sleep', name: '代謝失衡型睡眠處方',  tag: '睡眠', color: '#F5F0E8', accent: '#9B8B6B', emoji: '⏰', by: 'HabitNext 系統', description: '夜間血糖波動、低血糖反應導致半夜醒來、睡眠不穩、醒來依然疲憊。', count: 3 },
      { id: 'hormone-sleep',   name: '荷爾蒙波動型睡眠處方', tag: '睡眠', color: '#F3F0ED', accent: '#9B7C7C', emoji: '🔄', by: 'HabitNext 系統', description: '荷爾蒙波動影響體溫調節、情緒與睡眠深度，常見於經前、更年期、產後。', count: 2 },
    ],
  },
];
